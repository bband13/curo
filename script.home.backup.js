...
function performSearch(term) {
  ...
  searchMessage.textContent = `Searching demo hospitals for “${cleanTerm}” near ${location}…`;
  setTimeout(() => {
    searchMessage.textContent = `Found 12 demo hospitals matching “${cleanTerm}”. The results page will connect to the database later.`;
    showToast(`Search ready: ${cleanTerm}`);
  }, 650);
}
